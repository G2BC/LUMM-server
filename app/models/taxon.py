...
class Taxon(db.Model):
    ...
    __table_args__ = (db.Index("idx_taxonomies_species", "species_id"),)
    ...
    name_status = db.Column(db.Text, nullable=True)
    ...
    species = db.relationship("Species", back_populates="taxonomies")
